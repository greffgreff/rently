      ...
      <div>
        ...
        <div className={Styling.extraInputsContent}>
          <div className={Styling.extraInputsContentLayer}>
            <input onChange={event => setAddress(event.target.value)} className={Styling.addressInput} placeholder={'Enter an address...'} />
            <Select onSelect={setRange} options={['1 km', '2 km', '5 km', '10 km', '15 km', '20 km', '30 km', '40 km', '50 km', '75 km', '100 km', '200 km']} />
          </div>
        </div>
      </div>
